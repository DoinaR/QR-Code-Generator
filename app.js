...
// const imageFormats = document.querySelectorAll('input[name="format"]')
// BUTTON
...
// const findSelected = () => {
//   let selected = document.querySelector('input[name="format"]:checked')
//   //   console.log(selected)
// }
// imageFormats.forEach((imageFormat) => {
//   imageFormat.addEventListener('change', findSelected)
// })
